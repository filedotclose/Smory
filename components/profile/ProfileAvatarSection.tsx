  ...
  return (
    <div className="w-full max-w-xl mx-auto px-4 relative my-6">
      ...
      >
        ...
        {/* Fun Stamps/Stickers */}
        <div className="absolute left-6 top-8 -rotate-12 bg-filter-gold text-ink-black text-[9px] font-black uppercase tracking-widest px-2 py-0.5 border-[2px] border-ink-black shadow-[2px_2px_0px_0px_rgba(11,11,15,1)] select-none z-10">
          OFFICIAL ID
        </div>
