...
export default function InsightsPage() {
  return (
    <div className="min-h-screen relative p-4 sm:p-6 lg:p-8">
      <PixelParticleBackground type="sparks" density={40} className="fixed inset-0 opacity-30 pointer-events-none z-0 mix-blend-screen" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto pt-8">
        <header className="mb-10">
          ...
          <p className="text-[#A1A1AA] text-sm mt-1 uppercase tracking-widest font-bold">Uncover your patterns</p>
        </header>
        ...
        <div className="mb-6">
          <h2 className="text-xl font-bold text-white mb-2 uppercase tracking-tight" style={{ textShadow: "2px 2px 0px rgba(0,0,0,0.5)" }}>
            Discovery Tree
          </h2>
          <p className="text-[#A1A1AA] text-xs font-bold uppercase tracking-widest mb-4">Unlock behavioral nodes to understand your subconscious loops</p>
          <DiscoveryTree />
        </div>
      </div>
    </div>
